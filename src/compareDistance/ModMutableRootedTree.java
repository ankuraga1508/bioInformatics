 ...
 * @version The modified version of the $Id: MutableRootedTree.java 935 2008-07-22 16:52:04Z rambaut $
 *
 *
 */

public class ModMutableRootedTree implements RootedTree {
    public ModMutableRootedTree() {  super(); }
     ...
     */
    public ModMutableRootedTree(Tree tree, Node outGroup) {
     ...
     */
    public ModMutableRootedTree(RootedTree tree) {
        try {
    ...
    protected final Map<Taxon, Node> externalNodes = new LinkedHashMap<Taxon, Node>();
    ...
    protected class MutableRootedNode extends BaseNode {
        ...
        public void replaceChildren(List<? extends Node> nodes) {
            for( Node n : nodes ) {
                ((MutableRootedNode) n).setParent(this);
            }
